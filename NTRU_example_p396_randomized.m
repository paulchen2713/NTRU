% 
% NTRU (N-th Truncated Ring Unit) with randomized f, g, m, r
% 
clear;
clc;
%
...
display(g);
% fprintf('the private key f is: [%d  %d  %d  %d  %d  %d  %d]\n', f);
% fprintf('the private key g is: [%d  %d  %d  %d  %d  %d  %d]\n', g);
%
% find the inverse of f in Rp 
% 
[fp, indexp] = multiplicative_inverse_NTRU(f, p);
% fprintf('the inverse of f in Rp is: [%d  %d  %d  %d  %d  %d]\n', fp);
